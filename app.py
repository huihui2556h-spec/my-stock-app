    ...
    if stock_id:
        with st.spinner('AI 精算中...'):
            ...
            if not df.empty:
                ...
                ax1.axhline(curr_c+atr*1.9*bias, color='red', ls='--', alpha=0.3, label="五日壓力")
                ax1.axhline(curr_c-atr*1.6/bias, color='green', ls='--', alpha=0.3, label="五日支撐")
